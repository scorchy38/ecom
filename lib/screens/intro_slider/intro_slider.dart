...
class IntroScreenState extends State<IntroScreen> {
  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        title: "Cheapest",
        description: "Cheapest products of best quality.",
        styleDescription: TextStyle(
            color: Color(0xfffe9c8f),
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "illustrations/product_details_1.png",
      ),
    );
    slides.add(
      new Slide(
        title: "Fastest",
        description: "Fastest delivery and a lot of payment options.",
        styleDescription: TextStyle(
            color: Color(0xfffe9c8f),
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "illustrations/review_dialog.png",
      ),
    );
    slides.add(
      new Slide(
        title: "Trusted by celebrities!",
        description: "Trusted by all celebrities and influencers.",
        styleDescription: TextStyle(
            color: Color(0xfffe9c8f),
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "illustrations/manage_addresses.png",
      ),
    );
  }
